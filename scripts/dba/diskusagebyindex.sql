...
CREATE PROCEDURE [dbo].[DiskUsageByIndex] 
AS
BEGIN
	SET NOCOUNT ON;
...
begin
	...
	+'		CASE WHEN (i.status & 0x10)      = 0 THEN 0 ELSE 1 END AS ''Clstrd'',   '
...
select distinct dbName, TableName, IndexName, Clstrd, EstRowCount, ReservedKB / 1024 as ReservedMB from #tblHistoryIndex order by ReservedKB / 1024  desc
